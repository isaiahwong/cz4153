...
const SuccessPanel = (
  ...
  return (
    ...
    >
      ...
      <Box mt={3}>
        <Button variant="contained" className={style.button} onClick={onClick}>
...
export default function TransactionPanel() {
  ...
  const onSubmit = async () => {
    ...
    if (
      !searchDomain ||
      !searchTerms[searchDomain] ||
      searchTerms[searchDomain] == dnsContract.EMPTY_ADDRESS
    ) {
      setErrorSearch("Domain does not exist");
      return;
    }
